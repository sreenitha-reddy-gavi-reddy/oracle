...
const Editdata = () =>{
    ...
    console.log(id);
    useEffect(()=>{
        axios.get('http://168.138.138.67:5000/api/get-single-dth/'+id).then((res)=>{console.log(res.data.response)
    ...
    const handlesubmit=(e)=>{
        e.preventDefault();
        axios.put(`http://168.138.138.67:5000/api/update-dth/${id}`, formdata).then((res)=>{
            alert("Updated Sucessfully"); 
                console.log(res.data);
                window.location.replace(
                   "http://168.138.138.67:3000/DThpage/getdata"
                  );
        })
    }
    return(
