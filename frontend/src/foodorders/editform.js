...
const EditForm = () =>{
    ...
    console.log(id);
    useEffect(()=>{
        axios.get('http://168.138.138.67:5000/api/get-single-user/'+id).then((res)=>{console.log(res.data.response)
    ...
    const handlesubmit=(e)=>{
        e.preventDefault();
        axios.put('http://168.138.138.67:5000/api/update-user/'+id, {formdata}).then((res)=>{alert(res.data.msg)})
        window.location.replace(
            "http://168.138.138.67:3000/orderlist"
           );
    }
