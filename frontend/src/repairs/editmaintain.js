...
const Maintain=()=>{
    ...
    const {id}=useParams();
    useEffect(()=>{
        axios.get('http://168.138.138.67:5000/api/get-single-repair/'+id).then((res)=>{console.log(res.data)
    ...
    const handlesubmit=(e)=>{
        e.preventDefault();
        axios.put('http://168.138.138.67:5000/api/update-repair/:id'+id, {formdata}).then((res)=>{alert(res.data.msg)})
    }
